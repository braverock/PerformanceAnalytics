#' Meucci Invariant Projection
#'
#' \tabular{ll}{
#' Package: \tab www.symmys.com Risk functions\cr
#' Type: \tab Package\cr
#' Version: \tab 0.1\cr
#' Date: \tab 2011-12-09\cr
#' LazyLoad: \tab yes\cr
#' }
#'
#' Contains a collection of functions to project invariances
#' 
#' @name MeucciInvariantProjection-package
#' @aliases MeucciInvariantProjection
#' @docType package
#' @title Implements the Projection Invariant code from www.symmys.com
#' @author Ram Ahluwalia \email{rahluwalia@@gmail.com}
#' @references 
#' \url{http://www.symmys.com}
#' @keywords package meucci projection invariants annualization
#' @examples
#'         print(" This is a test example at the top of the MeucciInvariantProjection.R file ")
# library(roxygen)
library(roxygen2)
roxygen:::roxygen()
