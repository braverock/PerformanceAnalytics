---
title: "How to Contribute to PerformanceAnalytics"
...
This is a "how to" guide for writing and improving functions for finance-related R packages such as `PerformanceAnalytics`, with many of the principles are carried into other packages as well.  
...
Please write tests using the [`testthat`](https://testthat.r-lib.org/) package, which is a lightweight, no-dependency, full-featured package for unit testing.  More tests are always welcome!
