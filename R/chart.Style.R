`chart.Style` <-
function (R.fund, R.style, method = "constrained", main = NULL, colorset = "darkgray", legend.loc = NULL, ylim = c(0,1), las = 3, horiz = FALSE, cex = 1, ...)
{ # @author Peter Carl
...
#
# $Id: chart.Style.R,v 1.1 2008-02-23 05:32:37 peter Exp $
#
###############################################################################
