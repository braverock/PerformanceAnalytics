% $Header: /cvs/R/PerformanceAnalytics/inst/doc/PerformanceAnalyticsPresentation-UseR-2007.Rnw,v 1.2 2007-08-08 04:59:52 peter Exp $
...
\end{equation}
\item
\emph{Return.calculate} or \emph{CalculateReturns} (now depreciated) may be used to compute discrete and continuously compounded returns for data containing asset prices.
\end{itemize}
\end{frame}
