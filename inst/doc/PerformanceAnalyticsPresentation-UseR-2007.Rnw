% $Header: /cvs/R/PerformanceAnalytics/inst/doc/PerformanceAnalyticsPresentation-UseR-2007.Rnw,v 1.1 2007-08-07 12:32:27 brian Exp $
...
{Data Mining of Financial Data using PerformanceAnalytics}
...
\begin{frame}
  ...
  \begin{itemize}
    \item
    Exploratory Data Analysis in Finance often starts with visual examination of the data to:
      \begin{itemize}
        \item
...
\subsection{Set Up PerformanceAnalytics}
