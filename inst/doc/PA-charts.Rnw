...
\author{Peter Carl\\Guidance Capital Management \And
        Brian G. Peterson\\Diamond Consulting}
...
\code{\link{PerformanceAnalytics}}, and comment about some other measures.
\end{abstract}
