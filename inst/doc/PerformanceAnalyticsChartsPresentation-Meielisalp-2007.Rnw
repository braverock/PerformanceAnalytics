% $Header: /cvs/R/PerformanceAnalytics/inst/doc/PerformanceAnalyticsChartsPresentation-Meielisalp-2007.Rnw,v 1.1 2007-07-07 01:23:42 brian Exp $
...
\begin{frame}[fragile]
  ...
  \item
    ...
    \begin{itemize}
    \item
      Additional parameterization to make charts more useful.
    \item
